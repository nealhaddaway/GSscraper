                 ...
                 tabPanel("Home",
                          fluidRow(
                              column(10,
                                     ...
                                     br(),
                                     br(),
                                     'You can use this tool to perform structured searches of Google Scholar. Google Scholar is not a transparent or repeatable source of bibliographic data and should not be used as a primary source of information in a systematic review or rapid review. Howeer, it can be a useful supplementary source when used alongside a comprehensive set of bibliographic databases. GSscraper helps you to be as transparent as possible in how you conduct and report your searches of Google Scholar, and helps you to download and store bibliographic data by exporting all search results as CSV or RIS data.',
                                     br(),
                                     br(),
